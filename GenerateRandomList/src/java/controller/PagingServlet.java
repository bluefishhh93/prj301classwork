 ...
 * @author xuant
 */
@WebServlet(name="PagingServlet", urlPatterns={"/page"})
public class PagingServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        StudentDao c = new StudentDao();
            List<Student> listOfStudent = c.list;
            int page, numberPage = 6;
            int size = listOfStudent.size();
            int numOfPage = (size % 6 == 0 ? (size / 6) : (size / 6)+1);
            ...
            List<Student> listByPage = c.getListByPage((ArrayList<Student>) listOfStudent, start, end);
